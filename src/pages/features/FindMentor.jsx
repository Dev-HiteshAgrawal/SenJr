...
import { StaggerContainer, StaggerItem, HoverCard, AccentButton, FadeIn } from '../../components/common/MotionWrapper';
...
const FindMentor = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAF9] font-sans text-gray-900 flex flex-col pb-20">
      ...
      {/* Header */}
      <header className="bg-white px-4 pt-4 pb-3 sticky top-0 z-50 border-b border-gray-100 shadow-sm">
            ...
            {filtered.map((mentor) => (
              <StaggerItem key={mentor.id}>
                <HoverCard
                  ...
                  className="w-full p-4 text-left border-gray-200"
                >
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="relative shrink-0">
                      ...
                      {mentor.verificationStatus === 'verified' && (
                        <div className="absolute -bottom-1 -right-1 bg-[#10b981] rounded-full p-0.5 border-2 border-white shadow-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-0.5">
                        ...
                        {mentor.badge && (
                          <span
                            className="text-[9px] font-bold px-2 py-0.5 rounded-full text-white shrink-0 ml-2 shadow-sm"
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {(mentor.subjects || []).slice(0, 3).map((tag) => (
                          <span key={tag} className="bg-[#ECFDF5] text-[#10b981] text-[9px] font-bold px-2 py-0.5 rounded-full border border-[#D1FAE5]">
                            {tag}
                          </span>
                        ))}
                      </div>
                  ...
                  <AccentButton
                    ...
                    className="w-full text-xs py-2 bg-[#10b981] shadow-none w-full border-none rounded-xl hover:filter-none active:bg-emerald-600 transition-colors"
                  >
