    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 to-primary-50 flex items-center justify-center p-4">
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <StepProgress currentStep={1} totalSteps={4} labels={['Basic', 'Expertise', 'Profile', 'Complete']} />
          ...
          <p className="text-center text-gray-500 mt-6">
            ...
            <a href="/login" className="text-secondary-500 font-medium hover:underline">Sign in</a>
          </p>
        </div>
      </motion.div>
    </div>
