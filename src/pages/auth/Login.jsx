...
const Login = () => {
  ...
  const { login, signInWithGoogle, userData, user } = useAuth();
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      updateStreak(uid).catch(console.error);
      // Navigate — RoleRoute will redirect to correct dashboard
    ...
    <div className="min-h-screen bg-white font-sans text-gray-900 pb-8 flex flex-col">
      ...
      <header className="flex items-center px-4 py-4 relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <h1 className="text-lg font-bold tracking-wide uppercase">Log In</h1>
        </div>
      </header>
      ...
      <main className="flex-1 px-4 pt-8">
        {/* Error Banner */}
        {error && (
          <div className="flex items-center gap-3 mb-6 p-4 bg-red-50 border-2 border-red-200 rounded-xl text-red-700 text-sm font-medium">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-3 border-2 border-gray-900 focus:outline-none focus:border-primary-500 rounded-none transition-colors"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                required
                className="w-full pl-10 pr-12 py-3 border-2 border-gray-900 focus:outline-none focus:border-primary-500 rounded-none transition-colors"
              />
          ...
          {/* Google Sign In */}
          <button type="button" onClick={handleGoogleSignIn} disabled={loading} className="w-full group relative block">
            <div className="absolute inset-0 bg-gray-900 translate-y-1 translate-x-1 rounded-none transition-transform group-active:translate-x-0 group-active:translate-y-0" />
      ...
      <footer className="mt-auto py-6 text-center">
        <p className="text-gray-900 font-medium text-sm">
          ...
          <Link to="/join" className="font-bold underline underline-offset-2 hover:text-primary-600">
            Join Senjr
          </Link>
        </p>
      </footer>
