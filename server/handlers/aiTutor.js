...
async function generateWithGemini({ tutor, messages }) {
  ...
  // Gemini Chat history must alternate User/Model and end with Model (so next is User)
  // We merge trailing User messages into the current message to ensure this.
